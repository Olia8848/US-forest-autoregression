# -*- coding: utf-8 -*-
"""
Created on Thu May 14 13:07:51 2020
...
Years[numpy.argmin(AnnualMeansBA)]
# for j in range(numpy.size(AnnualMeansBA)):
#    print(Years[j], AnnualMeansBA[j])
...
plt.title('ARIMA(0,1,0), ecoreg. M261')
plt.legend(['model prediction', 'basal area'])
